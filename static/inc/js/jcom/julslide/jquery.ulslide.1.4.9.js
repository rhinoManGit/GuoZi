...
(function ($) {
    ...
    $.fn.ulslide = function (settings) {
        ...
        $('> *', thisObj).each(function (i) {
            ...
            liel.css("height", settings['height']);
        ...
        thisEl.uslRefreshClasses = function () {
            ...
            if (settings['pager']) {
                ...
                $(settings['pager']).parent().removeClass('usl-current-parent on');
                $(settings['pager'] + '.usl-pager-' + thisEl.uslCurrent()).parent().addClass('usl-current-parent on');
                $(settings['pager']).parent().removeClass('pageOn');
                $(settings['pager'] + '.usl-pager-' + thisEl.uslCurrent()).parent().addClass('pageOn');
            }
        };
