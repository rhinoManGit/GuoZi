...
class Index {
  ...
  timeseatflashend(req, res, next) {
    ...
    let param = {
      ...
      PCntClass: req.query.PCntClass //R석
    };
   ...
   *
   */
  seatchoiceinfo(req, res, next) {

    let url   = 'http://ticket.yes24.com/Pages/Perf/Sale/Ajax/Perf/SeatChoiceInfo.aspx';

    let param = {
      pIdTime: req.query.idTime ,//'989802',
      pIdSeat: req.query.pIdSeat //'R석-R석'
      /*pIdTime: '989802',
